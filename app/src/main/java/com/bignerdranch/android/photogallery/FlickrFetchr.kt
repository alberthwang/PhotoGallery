...
class FlickrFetchr {
    ...
    init {
        ...
        //execute asynchronous web request
    ...
    //get website data, uses flickrresponse to use flickr api to get images in form of list of galleryitem
